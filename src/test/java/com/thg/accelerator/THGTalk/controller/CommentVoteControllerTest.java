...
public class CommentVoteControllerTest {
  ...
  String uri = "/api/commentvote";
  CommentVote model1 = new CommentVote(
  ...
  CommentVote model2 = new CommentVote(
      UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc44"),
      VoteEnum.UPVOTE,
      UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc39"),
      UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc42"));
  ...
  public CommentVoteControllerTest() throws ParseException {
  }
  ...
  public void testSave() throws Exception {
    ...
    when(service.save(isA(CommentVote.class))).thenReturn(true);
    ...
    when(service.save(isA(CommentVote.class))).thenReturn(false);
    mvcResult = mvc.perform(MockMvcRequestBuilders.post(uri)
        .contentType(MediaType.APPLICATION_JSON_VALUE).content(inputJson)).andReturn();
    status = mvcResult.getResponse().getStatus();
  ...
  public void testUpdate() throws Exception {
    ...
    when(service.save(isA(CommentVote.class))).thenReturn(true);
    when(service.update(isA(CommentVote.class))).thenReturn(true);
    mvcResult = mvc.perform(MockMvcRequestBuilders.post(uri)
    ...
    when(service.update(isA(CommentVote.class))).thenReturn(false);
    mvcResult = mvc.perform(MockMvcRequestBuilders.put(uri + "/" + uuid.toString())
        .contentType(MediaType.APPLICATION_JSON_VALUE).content(mapToJson(model2))).andReturn();
    status = mvcResult.getResponse().getStatus();
  ...
  public void testGetModelByID() throws Exception {
    ...
    String headerValue = mvcResult.getResponse().getHeader("Location");
    UUID uuid = UUID.fromString(headerValue.substring(headerValue.lastIndexOf("/") + 1));
    when(service.getModelByID(uuid)).thenReturn(java.util.Optional.of(new CommentVote(
        uuid,
        VoteEnum.UPVOTE,
        UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc39"),
        UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc42"))));
  ...
  public void testGetAllModels() throws Exception {
    ...
    String headerValue = mvcResult.getResponse().getHeader("Location");
    UUID uuid = UUID.fromString(headerValue.substring(headerValue.lastIndexOf("/") + 1));
    when(service.getAllModels()).thenReturn(Collections.singletonList(new CommentVote(
        uuid,
        VoteEnum.UPVOTE,
        UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc39"),
        UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc42"))));
  ...
  @Test
  public void testGetCommentVotesByCommentID() throws Exception {
    MvcResult mvcResult;
    int status;
    ...
    String headerValue = mvcResult.getResponse().getHeader("Location");
    UUID uuid = UUID.fromString(headerValue.substring(headerValue.lastIndexOf("/") + 1));
    when(service.getCommentVotesByCommentID(model1.getCommentID()))
        .thenReturn(Collections.singletonList(new CommentVote(
            uuid,
            VoteEnum.UPVOTE,
            UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc39"),
            UUID.fromString("61614667-d279-11e7-a5ac-f941ac8dfc42"))));

    mvcResult = mvc.perform(MockMvcRequestBuilders.get(uri + "/bycomment/" + model1.getCommentID())
        .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    status = mvcResult.getResponse().getStatus();
    assertEquals(200, status);

    when(service.getCommentVotesByCommentID(isA(UUID.class))).thenReturn(Collections.emptyList());
    mvcResult = mvc.perform(MockMvcRequestBuilders.get(uri + "/bypost/" + model1.getCommentID())
        .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    status = mvcResult.getResponse().getStatus();
    assertEquals(404, status);
  }
